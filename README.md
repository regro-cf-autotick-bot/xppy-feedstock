...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/xppy-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10909&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/xppy-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `xppy` can be installed with:

```
conda install xppy
```

It is possible to list all of the versions of `xppy` available on your platform with:
